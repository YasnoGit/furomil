...
ActiveRecord::Schema.define(version: 2023_07_20_013022) do
  ...
  create_table "bookmarks", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["customer_id", "facility_id"], name: "index_bookmarks_on_customer_id_and_facility_id", unique: true
